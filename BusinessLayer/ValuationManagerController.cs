...
{
    public class ValuationManagerController
    {
        public ValuationManagerController() { }

        #region ValuationManager
        public DataSet ValuationManagerSelectAll(Int64 UserId, Int64 CreatedBy)
        {
            ...
            try
            {
                ...
                return Database.ExecuteDataset(CommandType.StoredProcedure, "AMS_ValuationManagerSelect", sqlParameter);
            }
            catch (Exception Exc)
            {
                throw Exc;
        ...
        public Int64 ValuationManagerEdit(Int64 Id, Int64 UserId, string Email, string FirstName, string LastName,
        ...
        Int64 CreatedBy, Int64 ModifiedBy, Int64 Status, string Option)
        {
            ...
            try
            {
                ...
                Database.ExecuteNonQuery(CommandType.StoredProcedure, "AMS_ValuationManagerEdit", sqlParameter);
