<%@ Page Title="" Language="C#" MasterPageFile="~/Clients/ClientsMaster.Master" AutoEventWireup="true" CodeBehind="JobOrderList.aspx.cs" Inherits="AMSProjectNew.Clients.JobOrderList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left"><i>My Job Orders</i></td>
    </tr>
    <tr>
        <td align="left">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="center" width="100px" runat="server" id="tdIncoming"><asp:LinkButton ID="lbtnIncoming" runat="server" Text="New Orders" onclick="lbtnIncoming_Click"></asp:LinkButton></td>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" >
                ...
                <tr>
                    <td colspan="3" align="right" style="padding:5px 0px 5px 0px;">
                        <asp:Button Width="150px" ID="btnCreateJob" runat="server" CssClass="Button" Text="Order New Valuation" onclick="btnCreateJob_Click"></asp:Button>
                    </td>
                </tr>
                <tr>
