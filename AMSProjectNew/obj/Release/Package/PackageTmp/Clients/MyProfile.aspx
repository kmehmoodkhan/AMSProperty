<%@ Page Title="" Language="C#" MasterPageFile="~/Clients/ClientsMaster.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="AMSProjectNew.Clients.MyProfile" %>
            ...
            <table cellpadding="0" cellspacing="0" width="900px">
                ...
                <tr>
                    <td colspan="3" align="center" style="height:50px; background-color:#FFFBCE;">
                        <table cellpadding="0" cellspacing="5" width="100%">
                            <tr><td>Add contact details for your profile</td></tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td class="TDTopBottom"><span class="ErrorBold">*</span></td>
                    <td class="TDRight">
                        <asp:DropDownList ID="ddlClientType" runat="server" CssClass="DDL" Width="210px">
                            <asp:ListItem Text="Select Type" Value="0" Selected="0"></asp:ListItem>
                            <asp:ListItem Text="Bank" Value="Bank"></asp:ListItem>
                            <asp:ListItem Text="Credit Union" Value="Credit Union"></asp:ListItem>
                            <asp:ListItem Text="Building Society" Value="Building Society"></asp:ListItem>
                            <asp:ListItem Text="Non Bank lender" Value="Non Bank lender"></asp:ListItem>
                ...
                <tr>
                    ...
                    <td class="TDTopBottom"></td>
                    <td class="TDRight">
                        <asp:TextBox ID="txtABN" runat="server" CssClass="TextBox"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="TDLeft">
...
function CheckValidation() {
    var Msg = "";
    if (document.getElementById("<%=chkChangePassword.ClientID%>").checked == true) {
        if (document.getElementById("<%=txtPassword.ClientID%>").value == "")
            Msg += "Password is required\n";
        if (document.getElementById("<%=txtConfirmPassword.ClientID%>").value == "")
            Msg += "Confirm password is required\n";
    }    
    if (document.getElementById("<%=ddlClientType.ClientID%>").value == "0")
        Msg += "Client type is required\n";
    ...
    if (Msg != "") {
        ...
        if (document.getElementById("<%=ddlClientType.ClientID%>").value == "0") document.getElementById("<%=ddlClientType.ClientID%>").focus();
