<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageTransactionType.aspx.cs" Inherits="AMSProjectNew.Admin.ManageTransactionType" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left" height="40px" style="padding-bottom:10px;"><i>Manage Transaction Types</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%">
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Transaction Type" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gvTransactionType" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                        PageSize="10" Width="100%" OnPageIndexChanging="gvTransactionType_PageIndexChanging" 
                        CssClass="Grid" onrowdatabound="gvTransactionType_RowDataBound" GridLines="None">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="&nbsp;Transaction Type" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>                                            
                                    &nbsp;<asp:Label ID="lblTransactionTypeName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"TransactionTypeName") %>'></asp:Label>
                                </ItemTemplate>
    ...
    <asp:Panel ID="pnlPopup" runat="server" CssClass="confirm-dialog1" Style="display: none;">
        <table width="400px" cellpadding="0" cellspacing="0" style="background-color: White;border: solid 2px #28578F;">
            <tr>
                <td class="PopupHeader">Transaction Type Add/Edit</td>
            </tr>              
            <tr>
                <td align="center" height="120px">
                    <table cellpadding="0" cellspacing="10">
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox Width="200px" ID="txtTransactionType" runat="server" CssClass="TextBox"></asp:TextBox></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    function CheckValidation() {
        var Msg = "";
        if (document.getElementById("<%=txtTransactionType.ClientID%>").value == "")
        ...
        if (Msg != "") {
            ...
            if (document.getElementById("<%=txtTransactionType.ClientID%>").value == "") document.getElementById("<%=txtTransactionType.ClientID%>").focus();
            return false;
        }
    }
</script>
