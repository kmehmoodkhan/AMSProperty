<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageAccessArangementsType.aspx.cs" Inherits="AMSProjectNew.Admin.ManageAccessArangementsType" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left" height="40px" style="padding-bottom:10px;"><i>Manage Access Arangements Types</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%">
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Access Arangements Types" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gvAccessArangementsType" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                            PageSize="10" Width="100%" OnPageIndexChanging="gvAccessArangementsType_PageIndexChanging" 
                            CssClass="Grid" onrowdatabound="gvAccessArangementsType_RowDataBound" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="&nbsp;AccessArangements Type" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>                                            
                                        &nbsp;<asp:Label ID="lblAccessArangementsTypeName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"AccessArangementsTypeName") %>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:Panel ID="pnlPopup" runat="server" CssClass="confirm-dialog1" Style="display: none;">
        <table width="450px" cellpadding="0" cellspacing="0" style="background-color: White;border: solid 2px #28578F;">
            <tr>
                <td class="PopupHeader">AccessArangements Type Add/Edit</td>
            </tr>              
            <tr>
                <td align="center" height="120px">
                    <table cellpadding="0" cellspacing="10">
                        ...
                        <tr>
                            <td>Access Arangements Type:</td>
                            <td><asp:TextBox Width="200px" ID="txtAccessArangementsType" runat="server" CssClass="TextBox"></asp:TextBox></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    function CheckValidation() {
        var Msg = "";
        if (document.getElementById("<%=txtAccessArangementsType.ClientID%>").value == "")
            Msg += "AccessArangements type is required\n";
        
        if (Msg != "") {
            Msg = "Error to submit form details\n\n" + Msg + "\n\nPlease resolve above error and try again.";
            alert(Msg);

            if (document.getElementById("<%=txtAccessArangementsType.ClientID%>").value == "") document.getElementById("<%=txtAccessArangementsType.ClientID%>").focus();
            return false;
        }
    }
</script>
