<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageValuationManager.aspx.cs" Inherits="AMSProjectNew.Admin.ManageValuationManager" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left"><i>Manage Valuation Manager</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%" >
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Valuation Manager" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:GridView ShowHeader="false" ID="gvValuationManager" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                            PageSize="10" Width="100%" OnPageIndexChanging="gvValuationManager_PageIndexChanging" 
                            CssClass="Grid" onrowdatabound="gvValuationManager_RowDataBound" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="&nbsp;Company" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <tr><td class="BlackText2"><%# DataBinder.Eval(Container.DataItem,"Suburb") %></td></tr>
                                        </table>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        &nbsp;<a href='ManageValuationManagerEdit.aspx?Id=<%# DataBinder.Eval(Container.DataItem,"UserId") %>'><img src="../Images/btn_edit.gif" border="0"></a><%--<asp:ImageButton ID="btnEdit" runat="server" Style="padding-right: 5px; height:15px;" ImageUrl="~/Images/btn_edit.gif" OnClick="btnEdit_Click" CausesValidation="False" ToolTip="Edit record" />--%>
                                    </ItemTemplate>
