<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageValuationManagerEdit.aspx.cs" Inherits="AMSProjectNew.Admin.ManageValuationManagerEdit" %>
            ...
            <table cellpadding="0" cellspacing="2" width="900px">
                <tr>
                    <td class="LeftTitle2" colspan="3" align="left" style="height:40px;" valign="bottom">
                        Add / Edit Valuation Manager
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="center" style="height:50px; background-color:#FFFBCE;">
                        <table cellpadding="0" cellspacing="5" width="100%">
                            <tr><td>Add contact details for Valuation Manager</td></tr>
