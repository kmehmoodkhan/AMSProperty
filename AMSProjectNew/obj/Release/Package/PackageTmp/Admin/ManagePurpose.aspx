<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManagePurpose.aspx.cs" Inherits="AMSProjectNew.Admin.ManagePurpose" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left" height="40px" style="padding-bottom:10px;"><i>Manage Purpose</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%">
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Purpose" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                <asp:GridView ID="gvPurpose" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                    PageSize="10" Width="100%" OnPageIndexChanging="gvPurpose_PageIndexChanging" 
                    CssClass="Grid" onrowdatabound="gvPurpose_RowDataBound" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="&nbsp;Purpose Type" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>                                            
                                &nbsp;<asp:Label ID="lblPurposeName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PurposeName") %>'></asp:Label>
                            </ItemTemplate>
            ...
            <tr>
                <td align="center" height="120px">
                    <table cellpadding="0" cellspacing="10">
                        ...
                        <tr>
                            <td>Purpose Type:</td>
                            <td><asp:TextBox Width="200px" ID="txtPurpose" runat="server" CssClass="TextBox"></asp:TextBox></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    function CheckValidation() {
        ...
        if (Msg != "") {
            ...
            if (document.getElementById("<%=txtPurpose.ClientID%>").value == "") document.getElementById("<%=txtPurpose.ClientID%>").focus();
            return false;
        }
    }
</script>
