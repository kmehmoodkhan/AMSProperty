<%@ Page Title="" Language="C#" MasterPageFile="~/ValuationCompany/ValuationCompanyMaster.Master" AutoEventWireup="true" CodeBehind="ManageValuers.aspx.cs" Inherits="AMSProjectNew.ValuationCompany.ManageValuers" %>
        ...
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%" >
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Valuer" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:GridView ShowHeader="false" ID="gvValuers" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                            PageSize="10" Width="100%" OnPageIndexChanging="gvValuers_PageIndexChanging" 
                            CssClass="Grid" onrowdatabound="gvValuers_RowDataBound" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        &nbsp;<a href='ManageValuersEdit.aspx?Id=<%# DataBinder.Eval(Container.DataItem,"UserId") %>'><img src="../Images/btn_edit.gif" border="0"></a><%--<asp:ImageButton ID="btnEdit" runat="server" Style="padding-right: 5px; height:15px;" ImageUrl="~/Images/btn_edit.gif" OnClick="btnEdit_Click" CausesValidation="False" ToolTip="Edit record" />--%>
                                    </ItemTemplate>
