<%@ Page Title="" Language="C#" MasterPageFile="~/Valuers/ValuersMaster.Master" AutoEventWireup="true" CodeBehind="GenerateReport.aspx.cs" Inherits="AMSProjectNew.Valuers.GenerateReport" %>
                                    ...
                                    <td class="TDRight">
                                        <table cellpadding="0" cellspacing="3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlTab2Plan" runat="server" CssClass="DDL" Width="163px">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList onclick="SetSiteLayoutText();" ID="ddlTab2SiteLayout" runat="server" CssClass="DDL" Width="500px">
                                                        ...
                                                        <asp:ListItem Value="Slightly Sloping." Text="Slightly Sloping."></asp:ListItem>
                                                        <asp:ListItem Value="Steeply Sloping." Text="Steeply Sloping."></asp:ListItem>
