    ...
    public partial class GenerateReport1 : System.Web.UI.Page
    {
        ...
        protected void btnTab1Submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //string[] InspectionDate = txtInspectionDate.Text.Trim().Split('/');
                //string[] ValuationsDate = txtValuationsDate.Text.Trim().Split('/');

                //string strInspectionDate = InspectionDate[1].ToString() + "/" + InspectionDate[0].ToString() + "/" + InspectionDate[2].ToString();
                //string strValuationsDate = ValuationsDate[1].ToString() + "/" + ValuationsDate[0].ToString() + "/" + ValuationsDate[2].ToString();
                ...
                if (CommonController.GetConfigurationVal("Mode") == "LOCAL")
                {
                    ...
                    strDate = txtValuationsDate.Text.Trim().Split('/');
                ...
                int valuationApproach = 0;

                if (ddlValuationApproach.SelectedValue.Length > 0)
                {
                    valuationApproach = Convert.ToInt32(ddlValuationApproach.SelectedValue);
                }
                ...
                JobId = objReportController.Tab1_SummaryEdit(JobId, txtMarketValue.Text.Trim(), txtUnitLot.Text.Trim(), txtStreetNumber.Text.Trim(),
                    ...
                    txtClient.Text.Trim(), txtTab1Instructions.Text.Trim(), valuationApproach);
                if (JobId > 0)
                {
                    lblPropertyAddress.Text = txtStreetNumber.Text + " " + txtStreetName.Text + " " + txtStreetType.Text + ", " +
                        txtSuburb.Text + "&nbsp;&nbsp;" + ddlState.SelectedValue + "&nbsp;&nbsp;" + txtPostcode.Text;
        ...
        protected void btnTab2Next_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                JobId = objReportController.Tab2_LandEdit(JobId, ddlTab2PropertyType.SelectedValue, ddlTab2PropertyIdentification.SelectedValue,
                    ...
                    Convert.ToInt64(Session["UserId"]), "ADD", ddlTab2SqmHectares.SelectedValue, txtTab2PlanText.Text.Trim());
                if (JobId > 0)
                {
                    ...
                    for (int i = 0; i < strRooms1.Length; i++)
                    {
                        for (int j = 0; j < chkTab4Rooms1.Items.Count; j++)
                        {
                            if (strRooms1[i].ToString() == chkTab4Rooms1.Items[j].Value.ToString())
                                chkTab4Rooms1.Items[i].Selected = true;
                        }
                    }
                    //chkTab3Shedding
                    ...
                    for (int i = 0; i < strRooms2.Length; i++)
                    {
                        for (int j = 0; j < chkTab4Rooms2.Items.Count; j++)
                        {
                            if (strRooms2[i].ToString() == chkTab4Rooms2.Items[j].Value.ToString())
                                chkTab4Rooms2.Items[i].Selected = true;
                        }
                    }
                    //chkTab3Pools
                    ...
                    for (int i = 0; i < strRooms3.Length; i++)
                    {
                        for (int j = 0; j < chkTab4Rooms3.Items.Count; j++)
                        {
                            if (strRooms3[i].ToString() == chkTab4Rooms3.Items[j].Value.ToString())
                                chkTab4Rooms3.Items[i].Selected = true;
                        }
                    }
                    //chkTab3Gardens
                    ...
                    for (int i = 0; i < strRooms4.Length; i++)
                    {
                        for (int j = 0; j < chkTab4Rooms4.Items.Count; j++)
                        {
                            if (strRooms4[i].ToString() == chkTab4Rooms4.Items[j].Value.ToString())
                                chkTab4Rooms4.Items[i].Selected = true;
                        }
                    }
                    ...
                    for (int i = 0; i < strHeatingCooling.Length; i++)
                    {
                        for (int j = 0; j < chkTab4HeatingCooling.Items.Count; j++)
                        {
                            if (strHeatingCooling[i].ToString() == chkTab4HeatingCooling.Items[j].Value.ToString())
                                chkTab4HeatingCooling.Items[i].Selected = true;
                        }
                    }
        ...
        public void FillTab6Comments()
        {
            ...
            try
            {
                ...
                txtTab6MethodologyOld.Text = "In assessing the market value of the property we have regard to sales of properties in the surrounding area.  \r\rThe sales evidence provided in this report is considered to be representative of the real estate market in the Heidelberg Heights and surrounding area over the past 12 months.\r\rThe sales chosen are properties of slightly inferior, slightly superior and comparable standard based on age, size of land, size dwelling, level of ancillary (external) improvements, location and overall appeal and level of establishment.";
        ...
        public void FillTab6CommentsOld()
        {
            ReportController objReportController = new ReportController();
            DataSet ds = new DataSet();
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //txtTab6Standard.Text = "The subject property is a " + ddlTab4Bedroom.SelectedValue + " bedroom " + ddlTab2PropertyType.SelectedValue + ", built in circa " + txtTab3YearBuilt.Text.Trim() + " of " + ddlTab3ExternalWalls.SelectedValue + " construction with " + ddltab3Roof.SelectedValue + " roof" + strAncillary + " \r\rInternally the " + ddlTab2PropertyType.SelectedValue + " presents in " + ddlTab3InternalCondition.SelectedValue + "\r\rExternally the property presents in " + ddlTab3ExternalCondition.SelectedValue;
                    ////txtTab6LastSaleofProperty.Text = Convert.ToString(ds.Tables[0].Rows[0]["LastSaleofProperty"]);
                    ////txtTab6Defects.Text = Convert.ToString(ds.Tables[0].Rows[0]["Defects"]);
                    //txtTab6Methodology.Text = Convert.ToString(ds.Tables[0].Rows[0]["Methodology"]);// +"\r\r\rSale 1:\r{must be an inferior within 10% of assessed value}\r\rSale 2:\r{must be a comparable value}\r\rSale 3:\r{must be a superior within 10% of assessed value}";
                    ////txtTab6Closing.Text = Convert.ToString(ds.Tables[0].Rows[0]["Closing"]);
        ...
        protected void btnTab8Next_Click(object sender, EventArgs e)
        {
            ...
            if (strReportUpload != "")
            {
                ...
                {
                    lblMessage.Text = "Error to update job status with report.";
                }
            }
            else
            {
                lblMessage.Text = "Error to generate pdf report.";
            }
        }
        ...
        private void FillPdfDetails(Document document, PdfFont font)
        {
            ...
            strPageContents += "<tr><td style='font-weight:bold;'>Transport:</td><td>Bus: Within " + Convert.ToString(dsTab2.Tables[0].Rows[0]["Transport"]) + " kilometre</td></tr>";
            ...
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["Garage"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["Garage"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Garage:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["Garage"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["Carport"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["Carport"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Carport:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["Carport"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["CarSpaces"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["CarSpaces"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Car Spaces:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["CarSpaces"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["Balcony"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["Balcony"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Balcony:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["Balcony"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["Verandah"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["Verandah"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Verandah:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["Verandah"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["Alfresco"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["Alfresco"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Alfresco:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["Alfresco"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            if (Convert.ToString(dsTab5.Tables[0].Rows[0]["Pergola"]) != "" && Convert.ToString(dsTab5.Tables[0].Rows[0]["Pergola"]) != "0")
                strPageContents += "<tr><td style='font-weight:bold;'>Pergola:</td><td>" + Convert.ToString(dsTab5.Tables[0].Rows[0]["Pergola"]) + " " + Convert.ToString(dsTab5.Tables[0].Rows[0]["SqmEq"]) + "</td></tr>";
            ...
            {
                strPageContents += "<tr><td colspan='2'>" + txtTab6Closing.Text.Trim().Trim().Replace("{marketvalue replace}", Convert.ToString(dsTab1.Tables[0].Rows[0]["MarketValue"])).Replace("\r", "<br />").Replace("{MARKET VALUE:}", "<br><br><br><b style='font-size:20px;'>MARKET VALUE: $" + Convert.ToString(dsTab1.Tables[0].Rows[0]["MarketValue"])) + "</b></td></tr>";
            ...
            */
            ...
            strHtml += "<tr><td>&nbsp;</td></tr>";
            strHtml += "<tr><td>&nbsp;</td></tr>";
            strHtml += "<tr><td style='font-weight:bold;'>Darwin Property Valuers</td></tr>";
            strHtml += "<tr><td>&nbsp;</td></tr>";
            ...
            strHtml += "<tr><td><b>ADDRESS:</b> PO Box 2354, Kent Town SA 5071 <b>TELEPHONE:</b> Office: 0417 950 606</td></tr>";
            strHtml += "<tr><td>&nbsp;</td></tr>";
            strHtml += "<tr><td>&nbsp;</td></tr>";
            strHtml += "</table>";
            strHtml += "<table width='800px' cellpadding='0' cellspacing='5' border='0' style='font-family:Verdana; font-size:17px; padding-left:50px;'>";
        ...
        private void AddHtmlHeader(Document document)
        {
            ...
            //strHtml += "<tr><td align='left' style='padding-left:120px;font-weight:bold;font-size:16px;font-family:verdana;'>" + lblPropertyAddress.Text.Trim() + "</td><td align='right' style='padding-right:50px;'><img style='width:160px; height:160px;' src='" + System.Configuration.ConfigurationManager.AppSettings["ImageURL"].ToString() + "CompanyLogo/" + lblCompanyLogo.Text.Trim() + "' /></td></tr>";
            strHtml += "<tr><td align='left' style='padding-left:120px;font-weight:bold;font-size:16px;font-family:verdana;'>" + lblPropertyAddress.Text.Trim() + "</td><td align='right' style='padding-right:50px;'><img style='width:160px; height:160px;' src='../CompanyLogo/" + lblCompanyLogo.Text.Trim() + "' /></td></tr>";
            strHtml += "<tr><td colspan='2'></td></tr>";
            strHtml += "<tr><td colspan='2'></td></tr>";
            strHtml += "<tr><td colspan='2'></td></tr>";
            strHtml += "</table>";
