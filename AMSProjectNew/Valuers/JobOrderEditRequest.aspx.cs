...
namespace AMSProjectNew.Valuers
{
    public partial class JobOrderEditRequest : System.Web.UI.Page
    {
        ...
        protected void btnSubmitRequest_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Int64 RetVal = objJobsController.JobEditRequestsEdit(0, Convert.ToInt64(Request.QueryString["JobId"]), txtRequestTitle.Text.Trim(), txtRequestDetails.Text.Trim().Replace("\r", "<Br>"), Convert.ToString(Session["FullName"]), "Valuers", Convert.ToInt64(Session["UserId"]), "ADD");
                if (RetVal > 0)
                {
