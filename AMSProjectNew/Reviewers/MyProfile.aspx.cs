...
{    
    public partial class MyProfile : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {                
                Int64 Id = reviewersController.ReviewersEdit(Convert.ToInt64(Session["UserId"]), Convert.ToInt64(Session["UserId"]), 
                    Convert.ToInt64(ddlCompany.SelectedValue), txtEmailAddress.Text.Trim(),
