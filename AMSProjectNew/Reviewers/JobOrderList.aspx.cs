    ...
    public partial class JobOrderList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    SetNotSelectedTD();
                    Session["TDSelectedJobJob"] = "Review";
                    SetSelectedTD();
                }
                FillJobs();
            }
        ...
        private void FillJobs()
        {
            ...
            try
            {
                ...
                ds = objJobsController.JobsSelectForReviewer(Convert.ToInt64(Session["UserId"]), hdnStatus.Value);
        ...
        public void SetNotSelectedTD()
        {
            ...
            tdReview.Attributes.Add("class", "TDNotSelected");
        ...
        public void SetSelectedTD()
        {
            ...
            else if (Session["TDSelectedJob"] != null && Convert.ToString(Session["TDSelectedJob"]) == "Review")
            {
                hdnStatus.Value = "7";
                tdReview.Attributes.Add("class", "TDSelected");
            }
