    ...
    public partial class JobOrderList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    SetNotSelectedTD();
                    Session["TDSelectedJobJob"] = "Queued";
                    SetSelectedTD();
                }
                FillJobs();
                CheckAllowJobCreate();
        ...
        private void FillJobs()
        {
            ...
            try
            {
                ...
                ds = objJobsController.JobsSelectForValuationCompany(Convert.ToInt64(Session["UserId"]), hdnStatus.Value);
        ...
        private void CheckAllowJobCreate()
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    if (Convert.ToString(ds.Tables[0].Rows[0]["AllowJobCreate"]) != "" && Convert.ToBoolean(Convert.ToString(ds.Tables[0].Rows[0]["AllowJobCreate"])) == true)
