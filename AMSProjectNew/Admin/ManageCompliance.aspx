<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageCompliance.aspx.cs" Inherits="AMSProjectNew.Admin.ManageCompliance" %>
...
function UncheckAllCategoryList(CheckItemComplianceID)
{
    var chkItem = document.getElementById(CheckItemComplianceID);
    var the_form = window.document.forms[0];
    for(var i=0; i<the_form.length; i++)
    {
        var temp = the_form.elements[i].type;
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left"><i>Manage Compliance</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%" >
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Compliance" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:GridView ShowHeader="false" ID="gvCompliance" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                            PageSize="10" Width="100%" OnPageIndexChanging="gvCompliance_PageIndexChanging" 
                            CssClass="Grid" onrowdatabound="gvCompliance_RowDataBound" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="&nbsp;Company" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <tr><td class="BlueText2"><%# DataBinder.Eval(Container.DataItem,"Suburb") %></td></tr>
                                        </table>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="&nbsp;Type" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>                                            
                                        <table cellpadding="0" cellspacing="0">
                                            <tr><td class="BlueText1"><%# DataBinder.Eval(Container.DataItem,"Email") %></td></tr>
                                            <tr><td class="BlackText2"><%# DataBinder.Eval(Container.DataItem,"Phone1") %></td></tr>
                                            <tr><td class="BlackText2"><%# DataBinder.Eval(Container.DataItem,"Phone2") %>&nbsp;</td></tr>
                                        </table>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        &nbsp;<a href='ManageComplianceEdit.aspx?Id=<%# DataBinder.Eval(Container.DataItem,"UserId") %>'><img src="../Images/btn_edit.gif" border="0"></a><%--<asp:ImageButton ID="btnEdit" runat="server" Style="padding-right: 5px; height:15px;" ImageUrl="~/Images/btn_edit.gif" OnClick="btnEdit_Click" CausesValidation="False" ToolTip="Edit record" />--%>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="btnDelete" runat="server" Style="padding-right: 5px; height:15px;" ImageUrl="~/Images/btn_delete.gif" OnClick="btnDelete_Click" CausesValidation="False" ToolTip="Delete record" OnComplianceClick="return confirm('Are you sure to delete the recor?');" />
                                    </ItemTemplate>
                                    <HeaderStyle Width="70px" HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </asp:TemplateField>
