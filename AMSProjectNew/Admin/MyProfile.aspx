<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="AMSProjectNew.Admin.MyProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left"><i>Administrator Profile</i></td>
    </tr>
    <tr>
                ...
                <tr>
                    <td colspan="3" align="center" style="height:50px; background-color:#FFFBCE;">
                        <table cellpadding="0" cellspacing="5" width="100%">
                            <tr><td>Profile contact detials for administrator</td></tr>
                            <tr><td class="Error">Fields marked as * are mandatory fields.</td></tr>
                            <tr><td align="center"><asp:Label CssClass="ErrorBold" ID="lblError" runat="server"></asp:Label></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
