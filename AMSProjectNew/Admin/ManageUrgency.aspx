<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageUrgency.aspx.cs" Inherits="AMSProjectNew.Admin.ManageUrgency" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left" height="40px" style="padding-bottom:10px;"><i>Manage Urgency</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%">
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Urgency" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gvUrgency" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                            PageSize="10" Width="100%" OnPageIndexChanging="gvUrgency_PageIndexChanging" 
                            CssClass="Grid" onrowdatabound="gvUrgency_RowDataBound" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="&nbsp;Urgency" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>                                            
                                        &nbsp;<asp:Label ID="lblUrgencyName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"UrgencyName") %>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:Panel ID="pnlPopup" runat="server" CssClass="confirm-dialog1" Style="display: none;">
        <table width="400px" cellpadding="0" cellspacing="0" style="background-color: White;border: solid 2px #28578F;">
            <tr>
                <td class="PopupHeader">Purpose Type Add/Edit</td>
            </tr>              
            <tr>
                <td align="center" height="120px">
                    <table cellpadding="0" cellspacing="10">
                        ...
                        <tr>
                            <td>Purpose Type:</td>
                            <td><asp:TextBox Width="200px" ID="txtUrgency" runat="server" CssClass="TextBox"></asp:TextBox></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    function CheckValidation() {
        var Msg = "";
        if (document.getElementById("<%=txtUrgency.ClientID%>").value == "")
            Msg += "Purpose type is required\n";
        
        if (Msg != "") {
            Msg = "Error to submit form details\n\n" + Msg + "\n\nPlease resolve above error and try again.";
            alert(Msg);

            if (document.getElementById("<%=txtUrgency.ClientID%>").value == "") document.getElementById("<%=txtUrgency.ClientID%>").focus();
            return false;
        }
    }
</script>
