...
{
    public partial class ManageClientsEdit : System.Web.UI.Page
    {
        ...
        private void FillClientDetails()
        {
            ...
            try
            {
                ds = clientsController.ClientsSelectAll(Convert.ToInt64(Request.QueryString["Id"]), "", 0);
        ...
        protected void btnCheckAvailabilty_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Id = usersController.UsersLoginCreate(txtUsername.Text.Trim(), txtPassword.Text.Trim(), "Clients", "CHECKUSERNAME");
                if (Id > 0)
                {
        ...
        {
            Response.Redirect("~/Admin/ManageClients.aspx", false);
        }
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                if (Request.QueryString["Id"] != null && Convert.ToString(Request.QueryString["Id"]) != "")
                {
                    ...
                    Id = clientsController.ClientsEdit(Id, Id, ddlClientType.SelectedValue, txtEmailAddress.Text.Trim(),
                    ...
                    {
                        lblError.Text = "Client details does not submitted successfully. Please try again later!";
                        return;
                    }
                }
                else
                {
                    ...
                    if (Id > 0)
                    {
                        Id = clientsController.ClientsEdit(0, Id, ddlClientType.SelectedValue, txtEmailAddress.Text.Trim(),
                            txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtCompanyName.Text.Trim(), txtAddress.Text.Trim(),
                            txtSuburb.Text.Trim(), ddlState.SelectedValue, txtPostcode.Text.Trim(), txtPhone1.Text.Trim(),
                            txtPhone2.Text.Trim(), txtOtherDetails.Text.Trim(), txtFax.Text.Trim(), txtABN.Text.Trim(),
                            Convert.ToInt64(Session["UserId"]), Convert.ToInt64(Session["UserId"]), 
        ...
        private long CreateLogin()
        {
            ...
            {                
                ...
                {
                    Id = usersController.UsersLoginCreate(txtUsername.Text.Trim(), txtPassword.Text.Trim(), "Clients", "CREATE");
                }
            }
            catch (Exception ex)
            {
