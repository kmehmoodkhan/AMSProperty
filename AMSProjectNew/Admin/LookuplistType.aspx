<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="LookuplistType.aspx.cs" Inherits="AMSProjectNew.Admin.LookuplistType" %>
    ...
    <asp:UpdatePanel ID="updJob" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td class="LeftTitle" align="left" height="40px" style="padding-bottom: 10px;">
                        <i>Manage Type</i>
                        <asp:HiddenField ID="listtype" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td style="background: white;">
                        <table cellpadding="0" cellspacing="10" width="100%">
                            <tr>
                                ...
                                <td align="center">
                                    <table width="400px" cellpadding="0" cellspacing="0" style="background-color: White;
                                        border: solid 2px #28578F;">
                                        <tr>
                                            ...
                                            <td align="center" height="120px">
                                                <table cellpadding="0" cellspacing="10">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox Width="200px" ID="txtPropertyName" runat="server" CssClass="TextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" align="center" height="40px">
                                                            <asp:Button CssClass="Button" ID="btnSubmit" runat="server" Text="Submit" OnClientClick="return CheckValidation();"
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gvPropertyType" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                        PageSize="100" Width="100%" OnPageIndexChanging="gvPropertyType_PageIndexChanging"
                            ...
                            <tr><td align="center" colspan="2"> <asp:Button CssClass="Button" ID="Button2" 
                                    runat="server" Text="Back" onclick="Button2_Click" /></td></tr>
    ...
    <script type="text/javascript">
        function CheckValidation() {
            ...
            if (Msg != "") {
                ...
                if (document.getElementById("<%=txtPropertyName.ClientID%>").value == "") document.getElementById("<%=txtPropertyName.ClientID%>").focus();
                return false;
            }
        }
    </script>
