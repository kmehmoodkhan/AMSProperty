<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManagePropertyType.aspx.cs" Inherits="AMSProjectNew.Admin.ManagePropertyType" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left" height="40px" style="padding-bottom:10px;"><i>Manage Property Type</i></td>
    </tr>
    <tr>
        <td  style="background:white;">
            <table cellpadding="0" cellspacing="10" width="100%">
                <tr>
                    ...
                    <td align="right"><asp:Button CssClass="Button" ID="btnNewEntry" runat="server" Text="New Property Type" onclick="btnNewEntry_Click" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gvPropertyType" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                            PageSize="10" Width="100%" OnPageIndexChanging="gvPropertyType_PageIndexChanging" 
                            CssClass="Grid" onrowdatabound="gvPropertyType_RowDataBound" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="&nbsp;Property Type" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>                                            
                                        &nbsp;<asp:Label ID="lblPropertyTypeName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PropertyTypeName") %>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:Panel ID="pnlPopup" runat="server" CssClass="confirm-dialog1" Style="display: none;">
        <table width="400px" cellpadding="0" cellspacing="0" style="background-color: White;border: solid 2px #28578F;">
            <tr>
                <td class="PopupHeader">Property Type Add/Edit</td>
            </tr>              
            <tr>
                <td align="center" height="120px">
                    <table cellpadding="0" cellspacing="10">
                        ...
                        <tr>
                            <td>Property Type:</td>
                            <td><asp:TextBox Width="200px" ID="txtPropertyType" runat="server" CssClass="TextBox"></asp:TextBox></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    function CheckValidation() {
        ...
        if (Msg != "") {
            ...
            if (document.getElementById("<%=txtPropertyType.ClientID%>").value == "") document.getElementById("<%=txtPropertyType.ClientID%>").focus();
            return false;
        }
    }
</script>
