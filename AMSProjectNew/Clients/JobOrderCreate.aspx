<%@ Page Title="" Language="C#" MasterPageFile="~/Clients/ClientsMaster.Master" AutoEventWireup="true" CodeBehind="JobOrderCreate.aspx.cs" Inherits="AMSProjectNew.Clients.JobOrderCreate" %>
...
<script type="text/javascript">
    function CheckValidation() {
        ...
        if (document.getElementById("<%=txtCustomerPhoneNumber.ClientID %>").value == "")
            Msg += "Customer phone number\n";
