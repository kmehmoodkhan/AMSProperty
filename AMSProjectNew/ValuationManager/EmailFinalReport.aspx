...
CodeBehind="EmailFinalReport.aspx.cs" Inherits="AMSProjectNew.ValuationManager.EmailFinalReport" Title="" %>
...
<table cellpadding="0" cellspacing="0" width="100%" >
    ...
    <tr>
        <td class="LeftTitle" align="left" style="height:20px;"><i>Final Report Email : <asp:Label ID="lblJobId1" runat="server"></asp:Label></i></td>
    </tr>
    <tr>
        <td  style="background:white; padding:0px 0px 20px 0px;" align="left">
            ...
            <table cellpadding="0" cellspacing="3" width="100%">
                <tr>
                    <td class="TDLeftTextLeft">Final Report:</td>
                    <td><asp:Label ID="lblFinalReport" runat="server"></asp:Label></td>
                </tr>
                <tr>
