<%@ Page Title="" Language="C#" MasterPageFile="~/ValuationManager/ValuationManagerMaster.Master" AutoEventWireup="true" CodeBehind="JobOrderCreate.aspx.cs" Inherits="AMSProjectNew.ValuationManager.JobOrderCreate" %>
    ...
    <tr>
        <td  style="background:white; padding:0px 0px 20px 0px;" align="center">
            <table cellpadding="0" cellspacing="2" width="900px">
                ...
                <tr>
                    ...
                    <td class="TDRight">
                        <table>
                            <tr>
                                <td>Select Client:</td>
                                <td><asp:DropDownList ID="ddlClients" runat="server" CssClass="DDL" Width="210px"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td>OR</td>
                                <td></td>
                            ...
                            <tr>
                                <td>Instructed By:</td>
                                <td><asp:TextBox ID="txtClientName" runat="server" CssClass="TextBox" Width="400px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Client Address:</td>
                                <td><asp:TextBox ID="txtClientAddress" runat="server" TextMode="MultiLine" Height="50px" CssClass="TextBox" Width="400px"></asp:TextBox></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="TDLeftNormalText">Valuation Instruction</td>
                    <td class="TDTopBottom">&nbsp;</td>
                    <td class="TDRight"><asp:FileUpload ID="fuVI" runat="server" /></td>
                </tr>
                <tr>
                    <td class="TDLeftNormalText">Property Report</td>
                    <td class="TDTopBottom">&nbsp;</td>
                    <td class="TDRight"><asp:FileUpload ID="fuPR" runat="server" /></td>
                </tr>
                <tr>
                    <td class="TDLeftNormalText">Overlays</td>
                    <td class="TDTopBottom">&nbsp;</td>
                    <td class="TDRight"><asp:FileUpload ID="fuOL" runat="server" /></td>
                </tr>
                <tr>
                    <td class="TDLeftNormalText">Title</td>
                    <td class="TDTopBottom">&nbsp;</td>
                    <td class="TDRight"><asp:FileUpload ID="fuTL" runat="server" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="TDTopBottom"></td>
                    <td class="TDRight">
                        <asp:CheckBox ID="chkSameAsClient" runat="server" Text="Same as Instructed By" onclick="SetClientDetails();" />
...
<script type="text/javascript">
    function CheckValidation() {
        var Msg = "";
        if (document.getElementById("<%=ddlClients.ClientID %>").value == "0" && document.getElementById("<%=txtClientName.ClientID %>").value == "")
            Msg += "Client\n";
