<%@ Page Title="" Language="C#" MasterPageFile="~/ValuationManager/ValuationManagerMaster.Master" AutoEventWireup="true" CodeBehind="JobOrderEdit.aspx.cs" Inherits="AMSProjectNew.ValuationManager.JobOrderEdit" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<asp:Label ID="lblAssignCompanyId" Visible="false" runat="server"></asp:Label>
<table cellpadding="0" cellspacing="0" width="100%" >
    <tr>
        <td class="LeftTitle" align="left"><i>Edit Job Details</i></td>
    </tr>
    <tr>
        <td  style="background:white; padding:0px 0px 20px 0px;" align="center">
            <table cellpadding="0" cellspacing="2" width="900px">
                <tr>
                    <td class="LeftTitleJobNo" colspan="3" align="left">
                        <asp:Label ID="lblJobNo" runat="server"></asp:Label>
                    </td>
                </tr>
                 <tr>
                    <td class="LeftTitle5" colspan="3" align="left">
                        <asp:Label ID="lblJobTitle" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="left" style="height:50px; background-color:#FFFBCE;">
                    ...
                    <td class="TDRight">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><asp:TextBox ID="txtClientAddress" TextMode="MultiLine" Height="65px" runat="server" CssClass="TextBox" Width="400px"></asp:TextBox></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="TDTopBottom"></td>
                    <td class="TDRight">
                        <asp:TextBox ID="txtAdditionalNotes" runat="server" CssClass="TextBox" Width="400px" TextMode="MultiLine" Height="40px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="TDLeftBoldTextLeftSide">
