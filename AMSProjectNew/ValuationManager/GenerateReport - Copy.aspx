                                ...
                                <tr>
                                    ...
                                    <td class="TDRight">
                                        ...
                                        <table cellpadding="0" cellspacing="3" id="tblTab8Internal" runat="server">
                                            <tr>
                                                <td valign="top">Internal Photo:&nbsp;<span class="ErrorBold">*</span></td>
                                                <td valign="top">
                                                <CuteWebUI:UploadAttachments InsertText="Upload Multiple files Now" runat="server" ID="Attachments1Internal" 
                                                    MultipleFilesUpload="true" OnAttachmentAdded="Attachments1Internal_AttachmentAdded">
                                                </CuteWebUI:UploadAttachments>
                                                <br />
                                                <asp:ListBox runat="server" ID="ListBox1" Visible="false" />
                                                </td>
                                                <td valign="top"><asp:Button Width="155px"  ID="btnTab8InternalPhoto" runat="server" CssClass="Button" Text="Upload" onclick="btnTab8InternalPhoto_Click"></asp:Button>
                                                <script runat="server">
                                                void InsertMsgI(string msg)
                                                {
                                                    ListBox1.Items.Insert(0, msg);
                                                    ListBox1.SelectedIndex = 0;
                                                }
                                                void Attachments1Internal_AttachmentAdded(object sender, AttachmentItemEventArgs args)
                                                {
                                                    InsertMsgI(args.Item.FileName + " has been uploaded.");
                                                }
