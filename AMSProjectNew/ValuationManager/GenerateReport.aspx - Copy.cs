...
namespace AMSProjectNew.ValuationManager
{
    public partial class GenerateReport : System.Web.UI.Page
    {
        ...
        protected void btnTab8PrimaryPhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (gvTab8Primary.Visible == true)
                {
                    lblTab8Error.Text = "You have already uploaded primary image, if you want to upload new image, delete existing and then try to upload new image.<br><br><b>System will allow only one primary image to upload.</b>";
                    return;
                }
                string strFileName = "";
                if (fuTab8Primary.FileName.ToString() != "")
                {
                    ...
                    strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fuTab8Primary.FileName.ToString());
                    File.Move(Server.MapPath("~/Tab8Files/") + fuTab8Primary.FileName.ToString(), strFileName);

                    //System.Drawing.Bitmap bmpOut = ImageUpload.CreateThumbnail(strFileName, 600, 550);
        ...
        protected void btnTab8ExternalPhoto_Click(object sender, EventArgs e)
        {
            ...
            foreach (AttachmentItem item in Attachments1External.Items)
            {
                ...
                //System.Drawing.Bitmap bmpOut = ImageUpload.CreateThumbnail(strFileName, 600, 470);
                //bmpOut.Save(strFileName);
        ...
        protected void btnTab8InternalPhoto_Click(object sender, EventArgs e)
        {
            ...
            foreach (AttachmentItem item in Attachments1Internal.Items)
            {
                item.CopyTo(Server.MapPath("~/Tab8Files/") + item.FileName);
                string strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(item.FileName);
                File.Move(Server.MapPath("~/Tab8Files/") + item.FileName, strFileName);
            ...
            Attachments1Internal.DeleteAllAttachments();
            ...
            for (int i = 0; i < fileCollection.Count; i++)
            {
                ...
                {
                    string strFileName = "";
                    uploadfile.SaveAs(Server.MapPath("~/Tab8Files/") + fileName);
                    strFileName = DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fileName);
                    strFileName = Server.MapPath("~/Tab8Files/" + strFileName);
                    SetFileDirect(uploadfile, Server.MapPath("~/Tab8Files/" + fileName), strFileName);
                    strFileName = Path.GetFileName(strFileName);
                    objReportController.Tab8_AttachmentsEdit(0, JobId, strFileName, "InternalPhoto", Convert.ToInt64(Session["UserId"]), "ADD");
                }
            }
        ...
        protected void btnTab8DefectPhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (fuTab8Defect.FileName.ToString() != "")
                {
                    ...
                    fuTab8Defect.SaveAs(Server.MapPath("~/Tab8Files/" + fuTab8Defect.FileName.ToString()));
                    strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fuTab8Defect.FileName.ToString());
                    File.Move(Server.MapPath("~/Tab8Files/") + fuTab8Defect.FileName.ToString(), strFileName);
        ...
        protected void btnTab8TitlePhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (fuTab8Title.FileName.ToString() != "")
                {
                    ...
                    strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fuTab8Title.FileName.ToString());
                    File.Move(Server.MapPath("~/Tab8Files/") + fuTab8Title.FileName.ToString(), strFileName);
        ...
        protected void btnTab8ZoningPhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (fuTab8Zoning.FileName.ToString() != "")
                {
                    ...
                    strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fuTab8Zoning.FileName.ToString());
                    File.Move(Server.MapPath("~/Tab8Files/") + fuTab8Zoning.FileName.ToString(), strFileName);
        ...
        protected void btnTab8OverlayPhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (fuTab8Overlay.FileName.ToString() != "")
                {
                    ...
                    strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fuTab8Overlay.FileName.ToString());
                    File.Move(Server.MapPath("~/Tab8Files/") + fuTab8Overlay.FileName.ToString(), strFileName);

                    System.Drawing.Bitmap bmpOut = ImageUpload.CreateThumbnail(strFileName, 780, 950);
                    bmpOut.Save(strFileName);
                    strFileName = Path.GetFileName(strFileName);
                }
        ...
        protected void btnTab8OthersPhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (fuTab8Others.FileName.ToString() != "")
                {
                    ...
                    strFileName = Server.MapPath("~/Tab8Files/") + DateTime.Now.ToString("MMddyyHHmffffff") + "_Attachment" + Path.GetExtension(fuTab8Others.FileName.ToString());
                    File.Move(Server.MapPath("~/Tab8Files/") + fuTab8Others.FileName.ToString(), strFileName);
        ...
        private void FillPdfDetails(Document document, PdfFont font)
        {
            ...
            for (int i = 0; i < dtAllPhotos.Rows.Count; i++)
            {
                ...
                ImageContents += "<tr><td align='center'><img src='" + ImageUrl + "' /></td></tr>";
        ...
        public void SetFileDirect(HttpPostedFile fileUploader, string OroginalFilePath, string filePath)
        {
            // Check file size (mustn't be 0)
            HttpPostedFile myFile = fileUploader;
            ...
            if ((nFileLen > 0))// && (System.IO.Path.GetExtension(myFile.FileName).ToLower() == ".jpg"))
            {
                ...
                bool success = ResizeImageAndUpload(newFile, filePath, 600, 470);
        ...
        public void SetFileDirectNew(FileUpload fileUploader, string OroginalFilePath, string filePath)
        {
            // Check file size (mustn't be 0)
        ...
        public bool ResizeImageAndUpload(System.IO.FileStream newFile, string folderPathAndFilenameNoExtension, double maxHeight, double maxWidth)
        {
            try
            {
                System.Drawing.Image imgOriginal = System.Drawing.Image.FromFile(folderPathAndFilenameNoExtension);
                //pass in whatever value you want
                System.Drawing.Image imgActual = ImageScale(imgOriginal);
                imgOriginal.Dispose();
                imgActual.Save(folderPathAndFilenameNoExtension);
                imgActual.Dispose();
                ...
                if (System.IO.Path.GetExtension(newFile.Name).ToLower() == ".jpeg" || System.IO.Path.GetExtension(newFile.Name).ToLower() == ".jpg")
                    outImage.Save(folderPathAndFilenameNoExtension, System.Drawing.Imaging.ImageFormat.Jpeg);
                if (System.IO.Path.GetExtension(newFile.Name).ToLower() == ".png")
                    outImage.Save(folderPathAndFilenameNoExtension, System.Drawing.Imaging.ImageFormat.Png);
                if (System.IO.Path.GetExtension(newFile.Name).ToLower() == ".gif")
        ...
        private System.Drawing.Image ImageScale(System.Drawing.Image imgPhoto)
        {
