                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="2" width="900px">
                                ...
                                <tr>
                                    <td class="TDRight" colspan="3" style="width: 90%">
...
<%--                                                                </Content>
                                                     ...
                                                     <div class="headerSelectedCss" style="margin-top:20px;">
						                                Add Section
                                                    ...
                                                    <div class="headerSelectedCss" style="margin-bottom:20px;">
						                                Photos/Documents   
					                                </div>
                                                                                        ...
                                                                                        <asp:GridView ID="GridViewSections" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#28578F" HeaderStyle-ForeColor="White">
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Image/Documents">
                                                                                                    <ItemTemplate>
                                                                                                        <a href='<%#DataBinder.Eval(Container.DataItem,"ImageUrl").ToString().Replace("~/","/") %>' target="_blank">
