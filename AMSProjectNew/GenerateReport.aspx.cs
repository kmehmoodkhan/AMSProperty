...
namespace AMSProjectNew
{
    public partial class GenerateReport : System.Web.UI.Page
    {
        ...
        private string GeneratePDF()
        {
            ...
            lblReportHtml.Text = "<a href='http://localhost:10004/FinalReportsTemp/" + pdfName + "' target='0'>Click here</a>";// + strPath + "<br><br><br>" + lblReportHtml.Text;
        ...
        private void FillPdfDetails(Document document, PdfFont font)
        {
            ...
            */
            ...
            strPageContents += "<table width='80%' cellpadding='0' cellspacing='5' style='font-family:Trebuchet MS; font-size:23px;color:gray;'><tr><td align='left'><br><img style='height:" + imgHeight1.ToString() + "px;width:" + imgWidth1.ToString() + "px' src='" + strLogoUrl + "' /></td></tr>";
            ...
            strPageContents += "<tr><td style='font-size:23px;'>" + strPropertyAddress1 + "</td></tr>";
            strPageContents += "<tr><td style='font-size:23px;'>" + strPropertyAddress2 + "</td></tr>";
            strPageContents += "<tr><td></td></tr>";

            if (Convert.ToString(dsTab1.Tables[0].Rows[0]["InstructedBy"]) == Convert.ToString(dsTab1.Tables[0].Rows[0]["Client"]))
            {
                strPageContents += "<tr><td style='color:#1494C7;'><b>CLIENT NAME:</b></td></tr>";
                strPageContents += "<tr><td style='font-size:23px;'>" + Convert.ToString(dsTab1.Tables[0].Rows[0]["Client"]) + "</td></tr>";
            }
            else
            {
                if (Convert.ToString(dsTab1.Tables[0].Rows[0]["InstructedBy"]) != "")
                {
                    ...
                    strPageContents += "<tr><td style='font-size:23px;'>" + Convert.ToString(dsTab1.Tables[0].Rows[0]["InstructedBy"]) + "</td></tr>";
                }
                strPageContents += "<tr><td style='color:#1494C7;'><b>CLIENT NAME:</b></td></tr>";
                strPageContents += "<tr><td style='font-size:23px;'>" + Convert.ToString(dsTab1.Tables[0].Rows[0]["Client"]) + "</td></tr>";
            ...
            strPageContents += "<tr><td style='font-size:23px;'>" + GetDateFormat(dsTab1.Tables[0].Rows[0]["InspectionDate"].ToString()) + "</td></tr>";
            strPageContents += "<tr><td></td></tr>";
            strPageContents += "<tr><td style='color:#1494C7;'><b>VALUATION DATE:</b></td></tr>";
            strPageContents += "<tr><td style='font-size:23px;'>" + GetDateFormat(dsTab1.Tables[0].Rows[0]["ValuationsDate"].ToString()) + "</td></tr>";
